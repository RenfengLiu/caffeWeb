...
MEAN_FILE = 'models/FoodMar16/food_mean.binaryproto'
DEPLOY_FILE = 'models/FoodMar16/deploy.prototxt'
MODEL_FILE = 'models/FoodMar16/googlenet_April_iter_50000.caffemodel'
LABEL_FILE = 'models/FoodMar16/label.txt'
RETURN_TOP_N = 10
