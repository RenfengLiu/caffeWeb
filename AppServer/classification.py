...
MEAN_FILE = 'models/FoodAug31/food_mean.binaryproto'
DEPLOY_FILE = 'models/FoodAug31/deploy.prototxt'
MODEL_FILE = 'models/FoodAug31/model.caffemodel'
LABEL_FILE = 'models/FoodAug31/label_Aug31.txt'
RETURN_TOP_N = 10
